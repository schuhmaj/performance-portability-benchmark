...
def plot_benchmarks(df: pd.DataFrame, save_path: Path = Path("./results.pdf")) -> tuple[plt.Figure, plt.Axes]:
    ...
    sns.lineplot(x="Problem Size", y="Runtime", hue="Framework", hue_order=df["Framework"].unique().sort(), data=df,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", type=Path, default=Path("result.pdf"),
