...
ppb::ImplAdaptiveCppShr<FloatType>::ImplAdaptiveCppShr()
    : queue{sycl::default_selector_v, {}, {sycl::property::queue::in_order(), sycl::property::queue::enable_profiling()}}
{}

template <typename FloatType>
std::pair<std::vector<FloatType>, double> ppb::ImplAdaptiveCppShr<FloatType>::operator()(const std::vector<FloatType> &a,
...
template class ppb::ImplAdaptiveCppShr<float>;
template class ppb::ImplAdaptiveCppShr<double>;
