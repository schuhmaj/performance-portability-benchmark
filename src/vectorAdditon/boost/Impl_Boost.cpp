...
BENCHMARK(ppb::VectorAddition<ppb::ImplBoost<float>>::benchmark)->Name("VecAdd-BoostCL-Float")->RangeMultiplier(10)->Range(1e3, 1e8)->Complexity();
BENCHMARK(ppb::VectorAddition<ppb::ImplBoost<double>>::benchmark)->Name("VecAdd-BoostCL-Double")->RangeMultiplier(10)->Range(1e3, 1e8)->Complexity();
